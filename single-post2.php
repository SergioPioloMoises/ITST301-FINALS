...
<head>
  ...
  <title>Papi Pyo - Single Post</title>
        ...
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
              <div class="post-meta"><span class="date">Blog</span> <span class="mx-1">&bullet;</span> <span>December 9 '22</span></div>
              <h1 class="mb-5">Let's Begin!!</h1>
              <p><span class="firstcharacter">H</span>i there! I’m <b>Sergio Piolo Espinase Moises</b>, Pyo for short. <i>You don't have to live your life the way others expect.</i> Life is short, Just be yourself and Enjoy it. This is my Personal Blog. And now you can discover some of my experiences.</p>

              <figure class="my-4">
                <img src="assets/img/post-sq-1.jpg" alt="" class="img-fluid">
              ...
              <p>Hailing from a working class family. I am simple, sweet, confident and cunning fellow. Sad to say but my father died because of cancer but he is an electrician and he love his profession with passion and dedication. While my mother is a hardworking teacher at Infanta Central Elementary school whose only passion is to transform the lives of her students with knowledge and a good vision.</p>
              <p>That’s I have learned, from the very start, the importance of passion, dedication, confidence and time management. We are four brothers and sisters among our parents and my grandmother. My family is what my parents had worked for, ie completely happy and satisfied one.</p>
              <p>I am the youngest of my two brother. Being the eldest one, sometimes, gives you the favors. Luckily, I am loved, cared and most favored upon in my all family.</p>
