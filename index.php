            ...
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                <div class="post-entry-1">
                  <a href="single-post.php"><img src="assets/img/post-landscape-2.jpg" alt="" class="img-fluid"></a>
                  <h2><a href="single-post.php">My Pet Kyubert</a></h2>
                  </div>
                <div class="post-entry-1">
                  <a href="single-post.php"><img src="assets/img/post-landscape-5.jpg" alt="" class="img-fluid"></a>
                  <h2><a href="single-post.php">Favorite Food</a></h2>
                  </div>
              </div>
              <div class="col-lg-4 border-start custom-border">
                <div class="post-entry-1">
                  <a href="single-post.php"><img src="assets/img/post-landscape-3.jpg" alt="" class="img-fluid"></a>
                  <h2><a href="single-post.php">Favorite Color</a></h2>
                  </div>
                <div class="post-entry-1">
                  <a href="single-post.php"><img src="assets/img/post-landscape-6.jpg" alt="" class="img-fluid"></a>
